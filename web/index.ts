...
const projectOptions: DropdownOption[] = [
	{ text: 'Automad', value: 'automad' },
	{ text: 'Automad Packages', value: 'automadPackages' },
	{ text: 'Revitron', value: 'revitron' },
	{ text: 'Revitron UI', value: 'revitronUi' },
	{ text: 'Airmad', value: 'airmad' },
];
...
const App = (_: any, state: AppState, setState: SetState) => {
	...
	url.pathname = `${encodeURIComponent(project)}.${fileType}`;
				...
				H(Field, {
					...
					input: H(TextInput, {
						...
						oninput: (val: string) => {
							...
							setLoadingState({ page: val, overrideUrl: url });
						},
					}),
				})
			)
